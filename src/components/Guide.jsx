...
export default function Guide() {
  return (
    <div className="bg-white dark:bg-neutral-900 border border-slate-200 dark:border-white/5 rounded-2xl p-5 space-y-4 shadow-md shadow-slate-300/50 dark:shadow-none">
        ...
        {steps.map(({ n, title, body }) => (
          <li key={n} className="flex gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-600 dark:text-neutral-500 mt-0.5 leading-relaxed">{body}</p>
            </div>
          </li>
        ))}
      </ol>
